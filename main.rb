...
puts "light_order.shipment = #{light_order.shipment}"
p light_order.shipment

#####
coffee_order = Order.new(1392, coffee_shipment)
# Nesting Object Instantiation
hala_order = Order.new(1270, Shipment.new(1111)  )
...
tildeee = Merchant.new("Tildee")

list_o_merchants = [hamled, tildeee]
...
list_o_merchants.each do |merchant|
